...
#
def read_from_directory(path: str, spark: SparkSession = SparkSession.getActiveSession()) -> FhirResource:
...
# ndjson FHIR data
#
def read_from_directory_ndjson(path: str, spark: SparkSession = SparkSession.getActiveSession()) -> FhirResource:
    pass
