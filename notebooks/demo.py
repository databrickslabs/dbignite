...
# MAGIC   3. Perform exploratory analysis on the data
# MAGIC <br>
# MAGIC </br>
...
# MAGIC %md
# MAGIC run the following command to just download the python `whl`
# MAGIC ```
# MAGIC %sh
# MAGIC pip install git+https://$token@github.com/databrickslabs/dbignite.git
# MAGIC ```
...
# MAGIC %md
# MAGIC ## 2. Extract resources from bundles
